...
import com.propagation.User.service.never.UserServicePropagationNeverChild;
import com.propagation.User.service.request_new.UserServicePropagationRequestNew;
...
public class UserServicePropagationTest {
    ...
    @Autowired
    UserServicePropagationRequestNew userServicePropagationRequestNew;
    ...
    public void Transactional_Request_New() {
        assertDoesNotThrow( () -> {
            userServicePropagationRequestNew.updateParent(1L);
        });
    }
    ...
    public void Transactional_Request_New_no_tx() {
        assertDoesNotThrow( () -> {
            userServicePropagationRequestNew.updateParentNoTx(1L);
        });
    }
